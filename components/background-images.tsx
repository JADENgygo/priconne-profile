                ...
                <div className="row gy-3 row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 row-cols-xl-6 text-center">
                  {
                    backgroundImageNames.map(value => (
                      <div className="col" key={ value }>
                        ...
                        <Form.Check type="radio" name="backgroundImageName" id={ value } value={ value } onChange={ props.onChange } checked={props.state.backgroundImageName === value} />
                          <Image src={ '/img/thumbnails/' + value } width={240} height={135} alt={ value } />
                        </Form.Label>
                      </div>
                    ))
                  }
